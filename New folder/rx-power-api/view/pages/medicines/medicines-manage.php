...
<div class='content-wrapper'>
  ...
  <section class='content'>
    <div class='container-fluid'>
      <a href="medicines-create" class="btn btn-primary mb-3">Add New</a>
...
<table class="table table-striped">
  ...
  <tbody>
  <?php
    $items = Medicines::readAll();
    foreach($items as $item){
      echo "<tr>";
      echo "<td>".$item['id']."</td>";
      echo "<td>".$item['name']."</td>";
      echo "<td>".$item['generic_name']."</td>";
      echo "<td>".$item['description']."</td>";
      echo "<td>".$item['medicine_type_id']."</td>";
  ?>
    <td>
      <form action="medicines-details" method="get">
        <input type="hidden" name="id" value="<?php echo $item['id']; ?>">
        <input type="submit" class="btn btn-info" value="Details">
      </form>
      <form action="medicines-edit" method="get">
        <input type="hidden" name="id" value="<?php echo $item['id']; ?>">
