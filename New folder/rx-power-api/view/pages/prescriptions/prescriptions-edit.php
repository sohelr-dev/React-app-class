...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $obj = new Prescriptions($id, $appointment_id, $doctor_id, $patient_id, $diagnosis, $notes, $advice, $tests, $follow_up_date, $created_at);
    $msg = $obj->update($id);
}
if (isset($_GET['id'])) {
    $res = Prescriptions::readById($_GET['id']);
}
...
<div class='content-wrapper'>
  <div class='content-header'>
    <div class='container-fluid'>
      <div class='row mb-2'>
        <div class='col-sm-6'>
          <h1 class='m-0'>Edit Prescriptions</h1>
        </div>
      </div>
    </div>
  </div>
  ...
  <form method="post">
    <div class="card-body">
      ...
      <div class="form-group mb-3">
        ...
        <input type="text" class="form-control" name="appointment_id" id="appointment_id" value="<?php echo htmlspecialchars($res['appointment_id']); ?>">
      </div>
      <div class="form-group mb-3">
