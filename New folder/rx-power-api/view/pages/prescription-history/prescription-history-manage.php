...
if(isset($_POST['delete_id'])) {
  $id = $_POST['delete_id'];
  $msg = PrescriptionHistory::delete($id);
}
...
<div class='content-wrapper'>
  <div class='content-header'>
    <div class='container-fluid'>
      <div class='row mb-2'>
        <div class='col-sm-6'>
          <h1 class='m-0'>Manage Prescription History</h1>
        </div>
      </div>
    </div>
  </div>
  <section class='content'>
    <div class='container-fluid'>
      <a href="prescription-history-create" class="btn btn-primary mb-3">Add New</a>
...
<table class="table table-striped">
  ...
  <tbody>
  <?php
    $items = PrescriptionHistory::readAll();
  ...
  ?>
    <td>
      <form action="prescription-history-details" method="get">
        <input type="hidden" name="id" value="<?php echo $item['id']; ?>">
        <input type="submit" class="btn btn-info" value="Details">
      </form>
      <form action="prescription-history-edit" method="get">
        <input type="hidden" name="id" value="<?php echo $item['id']; ?>">
