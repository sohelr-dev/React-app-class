  ...
  return (
    <nav className="navbar bg-dark bg-opacity-10 p-2">
      <div className="container-fluid d-flex align-items-center flex-nowrap">
        <label htmlFor="sidebar-toggle" className="cursor-pointer d-md-none me-2">
        ...
        <div>
          <form className="d-flex flex-grow-1 me-3" role="search">
            <input
              className="form-control form-control-md me-2" type="search" placeholder="Search" aria-label="Search" />
            <button
              className="btn btn-sm btn-outline-success" type="submit"> Search
            </button>
          </form>
        </div>
        {/* Notifications */}
        ...
        <div className="dropdown mt-2 me-sm-4">
          <a href="#" className="text-dark position-relative" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <ul className="dropdown-menu dropdown-menu-end">
            ...
            <li><a className="dropdown-item" href="#">New comment on your post</a></li>
            <li><a className="dropdown-item" href="#">New follower</a></li>
        ...
        <div className="dropdown">
          ...
          <a href="#" className="dropdown-toggle d-flex align-items-center" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <span className="ms-2 d-none d-sm-inline fw-semibold">SOHEL RANA</span>
          </a>
