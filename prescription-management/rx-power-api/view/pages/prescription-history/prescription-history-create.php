...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $obj = new PrescriptionHistory(null, $prescription_id, $doctor_id, $patient_id, $diagnosis, $notes, $advice, $tests, $follow_up_date, $created_at);
    $msg = $obj->create();
}
...
<div class='content-wrapper'>
  <div class='content-header'>
    <div class='container-fluid'>
      <div class='row mb-2'>
        <div class='col-sm-6'>
          <h1 class='m-0'>Create Prescription History</h1>
        </div>
      </div>
    </div>
  </div>
